...
export default function Footer() {
  return (
    <footer className="w-full border-t">
      <div className="mx-auto max-w-6xl px-8 py-16 text-gray-500">
        <div className="flex flex-col justify-between gap-8 pb-14 md:flex-row">
          <div className="grid gap-8">
            ...
            <ul className="grid gap-3">
              ...
              <li>
                <Link href="https://www.instagram.com/yelevo/">Instagram</Link>
              </li>
              <li>
                <Link href="https://www.facebook.com/people/Yelevo/100094363737525/">
                  Facebook
                </Link>
              </li>
            </ul>
          ...
          <div>
            <div className="grid gap-4">
              <span className="text-sm uppercase">entre em contato</span>
              ...
              <form>
                <div className="flex justify-center gap-3">
                  <input
                    type="text"
                    placeholder="Email"
                    className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm outline-none ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  />
              ...
              <span className="text-sm">
                Yelevo. Todos direitos reservados, 2023.
              </span>
            </div>
          </div>
        </div>
        <div className="flex justify-between border-t py-4">
          <span>&copy; Yelevo</span>
          <div className="flex gap-2">
            <Link href="https://www.instagram.com/yelevo/">
              <svg
